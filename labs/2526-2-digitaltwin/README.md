...
On supposera que les bâtiments sont construits sur plusieurs niveaux. Le dernier niveau correspond au toit qui peut recevoir des équipements (climatiseur, récupérateur d'eau, station méteo, antenne de communication, panneau photovoltaïque, ruche, serre ...). Chaque niveau contient des salles, des couloirs et des passages (escalier, ascenceur, monte charge ...). Pour chaque espace, on connait ses dimensions, sa surface, ses vitres interieurs/exterieures, ses ouvrants, ses coordonnées relatives en mêtre au point (latitude et longitude du batiment ...). On attribue une fonction aux salles : bureau, kfet, salle de détente, entrepot, labo, salle de réunion, bibliothéque, toilette, douche, cuisine, bar, salle de TD, amphi, garage (vélo, voiture ...), patio (outdoor sur le plan de masse ci-dessous) ...
